...
-- 本脚本可重复执行：全部使用 INSERT IGNORE，且会把 seed 账号密码统一更新为 BCrypt
...
INSERT IGNORE INTO sys_user (id, username, password, role, status) VALUES
...
-- 兼容旧库：若这些账号是早期用明文导入的，这里统一把密码更新为 BCrypt（否则新代码用 BCrypt 校验会登录失败）
UPDATE sys_user SET password = '$2a$10$r2Y7gE4Td8iMMAhE7vMqHuxdR1MBqSAadZmoInJSd5YMUs/RfBBxi' WHERE username IN ('admin', 'T001', 'T002', '2023005001');
...
-- 校区
INSERT IGNORE INTO base_campus (id, name, address) VALUES
(1, '东校区', '武汉市洪山区珞瑜路 100 号'),
(2, '西校区', '武汉市江夏区藏龙岛大道 88 号');

-- 系部
INSERT IGNORE INTO base_department (id, name, code) VALUES
(1, '信息工程系', 'XXGC'),
(2, '经济管理系', 'JJGL');

-- 教研室
INSERT IGNORE INTO base_teaching_group (id, name, department_id) VALUES
(1, '软件技术教研室',   1),
(2, '计算机应用教研室', 1),
(3, '会计教研室',       2);

-- 教师（type：专职/校内兼职/校外兼职，支持分类查询）
INSERT IGNORE INTO base_teacher (id, teacher_no, name, gender, type, phone, department_id, teaching_group_id) VALUES
...
-- 专业
INSERT IGNORE INTO base_major (id, name, code, department_id) VALUES
(1, '软件技术',       'RJ01', 1),
(2, '计算机应用技术', 'JSJ01', 1),
(3, '大数据与会计',   'KJ01', 2);

-- 班级
INSERT IGNORE INTO base_class (id, name, major_id, campus_id, grade, student_count, counselor) VALUES
(1, '软件技术2301班',     1, 1, '2023', 40, '刘老师'),
(2, '软件技术2302班',     1, 1, '2023', 38, '刘老师'),
(3, '大数据与会计2301班', 3, 2, '2023', 42, '陈老师');

-- 学生
INSERT IGNORE INTO base_student (id, student_no, name, gender, class_id, phone, status) VALUES
...
INSERT IGNORE INTO base_course (id, course_code, name, credit, type, teaching_group_id) VALUES
...
-- 教室（status：占用/空闲）
INSERT IGNORE INTO base_classroom (id, room_no, campus_id, type, area, capacity, status) VALUES
...
INSERT IGNORE INTO base_term (id, name, start_date, end_date, status) VALUES
...
INSERT IGNORE INTO base_teaching_task (id, teacher_id, course_id, class_id, term_id, weekday, start_section, end_section, classroom_id, weeks) VALUES
...
INSERT IGNORE INTO exam_apply (id, course_id, teacher_id, apply_type, reason, status) VALUES
(1, 1, 1, '闭卷', 'Java程序设计为专业核心课程，采用闭卷笔试考核', 'PASS'),
(2, 2, 2, '开卷', '数据库原理侧重设计与分析能力，采用开卷考核',   'WAIT'),
(3, 3, 3, '机考', 'Web前端开发采用上机实操考核',                   'PASS');

-- 考试安排（当前学期期末）
INSERT IGNORE INTO exam_info (id, name, course_id, term_id, exam_type, exam_date, start_time, end_time, status) VALUES
...
INSERT IGNORE INTO exam_room (id, exam_id, classroom_id, seat_count) VALUES
(1, 1, 1, 60),
(2, 1, 2, 60),
(3, 2, 3, 50),
(4, 3, 5, 55);
...
INSERT IGNORE INTO exam_monitor (id, exam_id, teacher_id, monitor_role) VALUES
(1, 1, 1, 'MAIN'),
(2, 1, 2, 'SUB'),
(3, 2, 2, 'MAIN'),
(4, 2, 3, 'SUB'),
...
INSERT IGNORE INTO exam_score (id, exam_id, student_id, score, status) VALUES
(1,  1, 1, 85,   'NORMAL'),
(2,  1, 2, 92,   'NORMAL'),
(3,  1, 3, 45,   'NORMAL'),
(4,  1, 4, 78,   'NORMAL'),
...
INSERT IGNORE INTO exam_retake (id, student_id, course_id, exam_id, type) VALUES
(1, 3, 2, NULL, '重修'),
(2, 4, 1, NULL, '补考');
...
INSERT IGNORE INTO graduate_check (id, student_id, check_status, credit_status, course_status, remark, checker) VALUES
...
INSERT IGNORE INTO graduate_student (id, student_id, graduate_year, certificate_no, graduate_status) VALUES
(1, 1, '2026', NULL, '已毕业'),
(2, 2, '2026', NULL, '在读');

-- 专升本报名（apply_status：WAIT/PASS/FAIL）
INSERT IGNORE INTO upgrade_apply (id, student_id, school_name, major_name, apply_status, remark) VALUES
...
INSERT IGNORE INTO teacher_attendance (id, teacher_id, attendance_date, status, check_time) VALUES
(1, 1, CURDATE(), '正常', NOW()),
(2, 2, CURDATE(), '正常', NOW()),
(3, 3, CURDATE() - INTERVAL 1 DAY, '迟到', NOW() - INTERVAL 1 DAY);

-- 教学日志（授课日期为昨天，演示周日志查询）
INSERT IGNORE INTO teaching_log (id, teacher_id, course_id, class_id, teaching_date, content, homework) VALUES
...
INSERT IGNORE INTO student_attendance (id, student_id, course_id, attendance_date, status) VALUES
...
INSERT IGNORE INTO classroom_apply (id, room_id, applicant, class_name, apply_date, time_slot, purpose, reason, status, create_time) VALUES
...
-- ============ 七、调课申请数据 ============
-- 状态：待审核/已通过/已驳回/已撤销
INSERT IGNORE INTO course_adjust (id, teacher_id, course_id, class_id, origin_date, origin_slot, target_date, target_slot, classroom_id, reason, status, approve_remark, create_time) VALUES
