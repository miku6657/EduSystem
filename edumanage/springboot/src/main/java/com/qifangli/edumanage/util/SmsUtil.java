...
public class SmsUtil {
    ...
    // 阿里云短信密钥通过环境变量注入，避免在代码中硬编码
    private final IAcsClient client;

    public SmsUtil() {
        String accessKeyId = System.getenv().getOrDefault("ALIYUN_ACCESS_KEY_ID", "");
        String accessKeySecret = System.getenv().getOrDefault("ALIYUN_ACCESS_KEY_SECRET", "");
